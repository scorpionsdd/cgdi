<%@ Page language="c#" Codebehind="view_mapeo_recibidos.aspx.cs" AutoEventWireup="false" Inherits="Gestion.Correspondencia.view_mapeo_recibidos" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Vista de Recibidos</title>
				...
				switch (operationTag) {
					...
					case "Detail":
						if (!bSended) {
							...
							var sURL = "edit_mapeo_recibidos.aspx?id=" + arguments[1];													
	...
	<body oncontextmenu="return true;" MS_POSITIONING="GridLayout">
		<form id="frmEditor" method="post" runat="server">
			<TABLE height="100%" width="100%">
				<TR>
					<TD class="titleRow" style="HEIGHT: 27px" noWrap>Lista Recibidos</TD>
					...
					<td style="HEIGHT: 27px" noWrap><A href="javascript:doOperation('Detail','');"><IMG style="WIDTH: 16px; HEIGHT: 12px" height="12" hspace="6" src="/gestion/images/workflow/manny.gif"
								...
								<td vAlign="top" width="100%">
									<div style="WIDTH: 100%; HEIGHT: 100%; OVERFLOW: auto">
										<asp:datagrid id="grdItems" tabIndex="-1" runat="server" AutoGenerateColumns="False" Width="100%"
											...
											<Columns>
												<asp:BoundColumn DataField="rowId" DataFormatString="&lt;img class=imageButton src='/gestion/images/icons_sm/document_sm.gif'; onclick=&quot;return doOperation('Detail', '{0}')&quot;&gt;"></asp:BoundColumn>
												<asp:BoundColumn DataField="id_empleado" SortExpression="id_Empleado ASC" HeaderText="Usuario">
													<HeaderStyle Wrap="False"></HeaderStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="Nombre" SortExpression="Nombre ASC" HeaderText="Nombre">
													<HeaderStyle Wrap="False" HorizontalAlign="Left"></HeaderStyle>
													<ItemStyle HorizontalAlign="Left"></ItemStyle>
													<FooterStyle Wrap="False" HorizontalAlign="Left"></FooterStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="id_destinatario" SortExpression="id_destinatario ASC" HeaderText="Destinatario">
													<HeaderStyle Wrap="False"></HeaderStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="NombreAdd" SortExpression="NombreAdd ASC" HeaderText="Nombre">
