...
namespace Gestion.Correspondencia
{
	...
	/// </summary>
	public class edit_attach_replay : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			gnTurnarId		= Convert.ToInt32(Request.QueryString["tid"]);
			gsState			= Request.QueryString["state"].ToString();
		...
		{
			DataSet ds = Attached.GetAttach(gnDocumentId, gsMailType);
		...
		private void btnSave_Click(object sender, System.EventArgs e)
		{
			...
			if (UploadedFile.Value != "")
			{
				...
				userMessage.Text = "El último archivo guardado es:  " + uploadedFileInfo.Name;
			}
		}
...
//			int nValue = Convert.ToInt32( ( (DropDownList)e.Item.FindControl("addressee")).SelectedItem.Value );
		...
		private void txtMailType_TextChanged(object sender, System.EventArgs e)
		{
		...
		public int gnTurnarId 
		{
			get {return int.Parse(txtTurnarId.Text);}
