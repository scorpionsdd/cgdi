<%@ Page language="c#" Codebehind="edit_mapeo_recibidos.aspx.cs" AutoEventWireup="false" Inherits="Gestion.Correspondencia.edit_mapeo_recibidos" %>
	...
	<body oncontextmenu="return true;" MS_POSITIONING="GridLayout">
		<form id="frmEditor" method="post" runat="server">
			<TABLE height="100%" width="100%">
				<TR>
					<TD class="titleRow" style="HEIGHT: 23px" noWrap>Edición&nbsp;Correo Recibido</TD>
						...
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								...
								<td style="HEIGHT: 45px" vAlign="top" noWrap><SELECT id="cboArea" style="WIDTH: 400px" tabIndex="6" name="cboArea" runat="server">
										...
										runat="server"><br>
									<DIV id="lblArea" style="WIDTH: 64px; DISPLAY: inline; HEIGHT: 19px" runat="server" ms_positioning="FlowLayout">
                                    <SELECT id="cboArea_" style="WIDTH: 400px" tabIndex="6" name="cboArea_" runat="server" visible="False">
									</SELECT></DIV>
								    <asp:CheckBox ID="chkAreaT" runat="server" Text="Incluir Subáreas" Visible="False" />
								</td>
							</tr>
