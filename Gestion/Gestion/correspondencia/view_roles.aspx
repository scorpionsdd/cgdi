<%@ Page language="c#" Codebehind="view_roles.aspx.cs" AutoEventWireup="false" Inherits="Gestion.Correspondencia.view_roles" %>
				...
				switch (operationTag) {
					...
					case "Detail":
						if (!bSended) {
							...
							var sURL = "edit_roles.aspx?id=" + arguments[1];													
	...
	<body oncontextmenu="return true;" MS_POSITIONING="GridLayout">
		<form id="frmEditor" method="post" runat="server">
			<TABLE height="100%" width="100%">
				...
				<TR>
					<TD class="titleRow" style="HEIGHT: 27px" noWrap>Listade Roles</TD>
								...
								<td vAlign="top" width="100%">
									<div style="WIDTH: 100%; HEIGHT: 100%; OVERFLOW: auto">
										<asp:datagrid id="grdItems" tabIndex="-1" runat="server" AutoGenerateColumns="False" Width="100%"
											...
											<Columns>
												<asp:BoundColumn DataField="rol_id" DataFormatString="&lt;img class=imageButton src='/gestion/images/icons_sm/document_sm.gif'; onclick=&quot;return doOperation('Detail', {0})&quot;&gt;"></asp:BoundColumn>
												<asp:BoundColumn DataField="Nombre" HeaderText="Nombre">
													<HeaderStyle Wrap="False"></HeaderStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="Rol" SortExpression="Rol ASC" HeaderText="Rol">
