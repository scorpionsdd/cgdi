<%@ Page language="c#" Codebehind="view_empleados.aspx.cs" AutoEventWireup="false" Inherits="Gestion.Correspondencia.view_empleados" %>
				...
				switch (operationTag) {
					...
					case "Detail":
						if (!bSended) {
							...
							var sURL = "edit_empleados.aspx?id=" + arguments[1];													
	...
	<body oncontextmenu="return true;" MS_POSITIONING="GridLayout">
		<form id="frmEditor" method="post" runat="server">
			<TABLE height="100%" width="100%">
				<TR>
					<TD class="titleRow" style="HEIGHT: 27px" noWrap>Lista Empleados</TD>
								...
								<td vAlign="top" width="100%">
									<div style="WIDTH: 100%; HEIGHT: 100%; OVERFLOW: auto">
										<asp:datagrid id="grdItems" tabIndex="-1" runat="server" AutoGenerateColumns="False" Width="100%"
											...
											<Columns>
												<asp:BoundColumn DataField="id_empleado" DataFormatString="&lt;img class=imageButton src='/gestion/images/icons_sm/document_sm.gif'; onclick=&quot;return doOperation('Detail', {0})&quot;&gt;"></asp:BoundColumn>
												<asp:BoundColumn DataField="Clave_Empleado" SortExpression="Clave_Empleado ASC" HeaderText="Expediente">
												...
												<asp:BoundColumn DataField="Cve_Area" SortExpression="Cve_Area ASC" HeaderText="Clave">
													<HeaderStyle Wrap="False"></HeaderStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="Area" SortExpression="Area ASC" HeaderText="Area">
													<HeaderStyle Wrap="False" Width="65%"></HeaderStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="Fecha_Inicio" SortExpression="Fecha_Inicio ASC" HeaderText="Desde" DataFormatString="{0:d}">
													<HeaderStyle Wrap="False"></HeaderStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="Fecha_Fin" SortExpression="Fecha_Fin ASC" HeaderText="Hasta" DataFormatString="{0:d}">
													<HeaderStyle Wrap="False"></HeaderStyle>
												</asp:BoundColumn>
											</Columns>
