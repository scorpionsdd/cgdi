<%@ Page language="c#" Codebehind="edit_areas.aspx.cs" AutoEventWireup="false" Inherits="Gestion.Correspondencia.edit_areas" %>
				...
				<TR>
					<td vAlign="top" noWrap width="100%" colSpan="3" height="100%">
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								<td style="WIDTH: 113px; HEIGHT: 12px" vAlign="top" noWrap>Clave del Area:
								</td>
