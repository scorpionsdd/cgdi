<%@ Page language="c#" Codebehind="change_status_receive.aspx.cs" AutoEventWireup="false" Inherits="Gestion.Correspondencia.change_status_receive" %>
...
<HTML>
	...
	<body onload="Alternate_Mail();">
		<form id="change_status_receive" method="post" runat="server">
			<TABLE class="standardPageTable" id="Table1" cellSpacing="1" cellPadding="1" width="100%"
				border="0">
				<TR>
					<TD class="applicationTitle" noWrap style="HEIGHT: 18px">Editor de Estatus&nbsp;</TD>
					<TD align="right" colSpan="3" class="applicationTitle" style="HEIGHT: 18px"><IMG title="Cerrar y regresar a la página principal" onclick="window.location.href = '/gestion/portal/main.aspx'; "
