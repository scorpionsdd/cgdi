<%@ Page language="c#" Codebehind="view_mapeo_enviados.aspx.cs" AutoEventWireup="false" Inherits="Gestion.Correspondencia.view_mapeo_enviados" %>
				...
				switch (operationTag) {
					...
					case "Detail":
						if (!bSended) {
							...
							var sURL = "edit_mapeo_enviados.aspx?id=" + arguments[1];													
	...
	<body oncontextmenu="return true;" MS_POSITIONING="GridLayout">
		<form id="frmEditor" method="post" runat="server">
			<TABLE height="100%" width="100%">
				<TR>
					<TD class="titleRow" style="HEIGHT: 27px" noWrap>Lista Enviados</TD>
									...
									<div style="WIDTH: 100%; HEIGHT: 100%; OVERFLOW: auto">
										<asp:datagrid id="grdItems" tabIndex="-1" runat="server" AutoGenerateColumns="False" Width="100%"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="id_empleado_bis" SortExpression="id_empleado_bis ASC" HeaderText="Usuarios Bis">
													<HeaderStyle Wrap="False"></HeaderStyle>
												</asp:BoundColumn>
